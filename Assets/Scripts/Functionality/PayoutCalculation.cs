...
public class PayoutCalculation : MonoBehaviour
{
    ...
    internal void GeneratePayoutLinesBackend(List<int> y_index, int Count, bool isStatic = false, UnityEngine.Color? lineColor = null)
{
    GameObject MyLineObj = Instantiate(Line_Prefab, LineContainer);
    MyLineObj.transform.localPosition = new Vector2(InitialLinePosition.x, InitialLinePosition.y);
    ...
    UnityEngine.Color finalColor = lineColor ?? UnityEngine.Color.white;
    MyLine.color = finalColor;
